...
var _ = Describe("Dijkstra", func() {
	Context("Small graph", func() {
		...
		It("DijkstraNaive(1) on course test case with big shortcut", func() {
	...
	Context("Huge graph", func() {
		...
		It("DijkstraHeap(1)", func() {
			sortest_path := problems.DijkstraHeap(huge_graph, 1)
